...
import { Container, useToast, Center, Spacer, Flex, Text } from "@chakra-ui/react";
...
const WCMetadata = {
  name: "WalletConnect Pro",
  description: "Connect your wallet securely to any dApp using Ethereum addresses",
  url: "www.walletconnectpro.com",
  ...
  return (
    <>
      ...
      <Center mt="8" fontStyle={"italic"}>
        <Text fontSize="xl">Connect to dApps with Any ETH Address</Text>
      </Center>
